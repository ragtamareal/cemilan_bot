	...
	<div class="content-dashboard">
		...
		<form class="form-horizontal" role="form" method="POST" action="">
			...
			<div class="form-group">
				<label for="inputEmail1" class="col-lg-2 col-lg-offset-1 control-label">Name</label>
				<div class="col-lg-3">
					<input type="text" class="form-control" name="nama_dpn" placeholder="First Name" value="<?php echo $firstname; ?>">
				</div>
				<div class="col-lg-3">
					<input type="text" class="form-control" name="nama_blk" placeholder="Last Name" value="<?php echo $lastname; ?>">
				</div>
			...
			<div class="form-group">
				<label for="inputEmail1" class="col-lg-2 col-lg-offset-1 control-label">Address</label>
				<div class="col-lg-6">
