			...
			<div class="col-md-8">
				<form class="form-horizontal" role="form" action="" method="post">
					<div class="form-group first-form-group">
						...
						<div class="col-lg-6">
							<input type="text" class="form-control" value="PGN" name="utility" readonly="" />
						</div>
					...
					<div class="form-group first-form-group">
						<label for="inputEmail1" class="col-lg-4 control-label">ID Pelanggan</label>
						<div class="col-lg-6">
							<input type="text" class="form-control" name="id_pel" placeholder="ID Pelanggan" value="<?php echo $id_pel; ?>">
							<?php if (form_error('id_pel') != '') echo '<div class="error_label">'.form_error('id_pel').'</div>'; ?>
						</div>
					</div>
					<div class="form-group first-form-group">
						<label for="inputEmail1" class="col-lg-4 control-label">No. HP</label>
						<div class="col-lg-6">
							<input type="text" class="form-control" name="no_hp" placeholder="Nomor HP" value="<?php echo $no_hp; ?>">
					...
					<ul class="info-premium">
						...
						<li>
							...
							<div class="info-desc">
								...
								<p>
									Loremt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
								</p>
							</div>
						</li>
					</ul>
